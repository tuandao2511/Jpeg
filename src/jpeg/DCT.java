...
class DCT {
  ...
  public double[][] forwardDCT(float input[][],int c) {
  ...
  /*
   * This method preforms a DCT on a block of image data using the AAN methodg as
   * implemented in the IJG Jpeg-6a library.
   */
  public double[][] forwardDCT(float input[][],int c, int r, int comp) {
    double output[][] = new double[N][N];
    ...
    if (c ==0 && r==0 && comp ==0 ) new PixelArray("preprocess DCT",output, 8, 8);
